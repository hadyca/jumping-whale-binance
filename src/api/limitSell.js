...
export default async function limitSell(symbol, qty, sellPrice, serverTime) {
  ...
  const queryString = `symbol=${symbol}&side=SELL&type=LIMIT&timeInForce=GTC&quantity=${qty}&price=${sellPrice}&timestamp=${serverTime}`;
